...
import example.shashankitraj.wanderway.adapter.CustomAdapter;
import example.shashankitraj.wanderway.model.CityData;
   ...
   //             }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(MainActivity.this,"Hello There!",Toast.LENGTH_SHORT);
